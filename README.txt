...
[카드형 메인 페이지 보강]
- index.html: 메인 페이지를 카드형 대시보드 레이아웃으로 재구성했습니다.
- newsletter-renderer.css: nl- 접두사 카드형 메인 페이지 스타일을 추가했습니다.
- scripts/newsletter-index.js: 요약 카드, 분야 카드, 전체 기사 필터를 렌더링하도록 수정했습니다.
